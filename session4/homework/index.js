...
function ex2() {
    ...
    let {subject:s , dueDate:d , assignTo:a} = task
    console.log(s,d,a)
}
// ex2()
function ex3() {
    ...
    console.log(`Data type of the hits property is ${typeof jobSearch.hits}`)
    let b = jobSearch.hits
    for(let i in jobSearch.hits){
        let {jobTitle , locations , jobSalary , benefits , skills , jobRequirement} = jobSearch.hits[i]
        console.log(jobTitle , locations , jobSalary , benefits , skills , jobRequirement)
    }
}
// ex3()
function ex4() {
    ...
    while (true){
        let inputWords = prompt('Enter a keyword')
        if(inputWords == null || inputWords == undefined){
            break
        }else if(inputWords == 'debug'){
            alert(`${inputWords} : ${dictionary.debug}`)
        }else if(inputWords == 'done'){
            alert(`${inputWords} : ${dictionary.done}`)
        }else if(inputWords == 'defect'){
            alert(`${inputWords} : ${dictionary.defect}`)
        }else if(inputWords == 'pm'){
            alert(`${inputWords} : ${dictionary.pm}`)
        }else if(inputWords == 'ui/ux'){
            alert(`${inputWords} : ${dictionary['ui/ux']}`)
        }else {
            let a = prompt(`We could not find your word : ${inputWords} ,leave your explanation`)
            dictionary['inputWords'] = a
...
function ex5(){
    ...
    for(let i = 0; i < products.length; i++){
        console.log('-----------------------')
        console.log(`#${products[i]['#']}.${products[i].name}`)
...
function ex53(){
    ...
    let c = prompt('Enter your category').toLowerCase()
    for(let i = 0; i < products.length; i++){
        if(products[i].category.toLowerCase() == c){
            console.log(products[i])
        }
    }
}
...
function ex6() {
    ...
    for(let i = 0; i < listFe.length; i++) {
        console.log(`${i + 1}.${listFe[i].task} \n\complete: ${listFe[i].complete}`)
    }


    let command = prompt('Enter one of : new/update/delete/complete')
    if(command=='new'){
        let newTask = prompt('Enter new task')
        listFe.push({task: newTask,complete: false})
        console.log(listFe)
        ...
        for(let i = 0; i < listFe.length; i++){
            if(i == (position - 1)){
                ...
                listFe[i].task = update
            }
        }
        console.log(listFe)
    }else if(command=='complete') {
        let pos = Number(prompt('enter position'))
        for(let j = 0; j < listFe.length; j++) {
            if(j == (pos - 1)) {
                listFe[j].complete = true
            }
        }
        console.log(listFe)
    }else if(command=='delete'){
        let posDel = Number(prompt('enter position'))
        for(let x = 0; x < listFe.length; x++) {
            if(x == (posDel - 1)) {
                listFe.splice(x, 1)
            }
        }
...
function ex15() {
    ...
    // console.log(jobData.hits[0].benefits.length)
    for(let i = 0; i < jobData.hits[0].benefits.length;i++){
        
        console.log(jobData.hits[0].benefits[i].benefitValue)
        
    }
    // for(let j in jobData.hits[0]){
    //     console.log('------------------------')
    //     console.log(jobData.hits[0].jobTitle)
    //     // console.log(jobData.hits[0].benefits[j])
    // }
